...
rectangular or circular cross-section.  For clarity, we restricting our focus to sources that may be described using plane waves.  With regards to the geometric construction, we need only consider the unit incident wavevector, $\bhat\equiv\frac{\mbm{k}_i}{\|\mbm{k}_i\|}$The beam direction is
