...
\labcomps{\gvec} &= \rmats \samcomps{\gvec} \nonumber\\
        ...
        \Aboxed{ &= \rmats \samcomps{\vmat^{-1}} \rmatc \bmat \rcpcomps{\gvec} }\label{E:gvec_l},
\end{align}
...
\begin{equation}
    \samcomps{\gvec} = \samcomps{\defgrad^{-T}}\rmatc\bmat\rcpcomps{\gvec} \nonumber
\end{equation}
By writing the bragg condition (\eqnref{E:braggCondition}) in terms of lab-frame components by multiplying by the normalized components above \rmats\ leads to relation of the form 
\begin{equation}
    a \siw + b \cow = c \nonumber
\end{equation}
where
