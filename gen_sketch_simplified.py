...
tVec_d = np.c_[ -5.0,   3.0, -10.0].T
tVec_s = np.c_[  0.0,   0.0,   0.0].T
tVec_c = np.c_[  -2.1,  2.7,   0.5].T
...
def gen_sk(fname, det_size, det_pt, eVec,
    ...
    print >> fid, \
        'def sample_frame {                                            \n' + \
        '  line [linewidth=%fpt,linecolor=green,arrows=<->] (axlen,0,0)(p1)(0,axlen,0) \n' % (axwgt_pt) + \
        '  line [linewidth=%fpt,linecolor=green,arrows=->]  (p1)(0,0,axlen)            \n' % (axwgt_pt) + \
    ...
    print >> fid, \
        'def crystal_frame {                                           \n' + \
        '  line [linewidth=%fpt,linecolor=blue,arrows=<->] (axlen,0,0)(p1)(0,axlen,0) \n' % (axwgt_pt) + \
        '  line [linewidth=%fpt,linecolor=blue,arrows=->]  (p1)(0,0,axlen)            \n' % (axwgt_pt) + \
    ...
    print >> fid, \
        ...
        '      { line [lay=over,linewidth=.2pt,linecolor=lightgray,linestyle=dashed]                   \n' + \
